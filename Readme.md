...
<p> O objetivo principal deste desafio é colocar em prática os 4 pilares da OO: <strong>ABSTRAÇÃO, ENCAPSULAMENTO, HERANÇA E POLIMORFISMO,</strong> através de um projeto com a linguagem de programação Java. </p>
